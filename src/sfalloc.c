...
int main(int argc, char *argv[]) {
    ...
    int *value1 = sf_malloc(sizeof(int) * 5);
    ...
    *value1 = VALUE1_VALUE;
    ...
    printf("\n=== Test3: Allocate a second variable ===\n");
    ...
    *value2 = VALUE2_VALUE;
    ...
    printf("\n=== Test4: Allocate a third variable (test for case 1 of coalescing)===\n");
    int *value3 = sf_malloc(sizeof(int) * 8);
    null_check(value1, sizeof(int));
    ...
    printf("=== Test5: does value1 still equal %d ===\n", VALUE1_VALUE);
    check_prim_contents(value1, VALUE1_VALUE, "%d", "value1");
    //press_to_cont();

    // Snapshot the freelist
    printf("=== Test6: Perform a snapshot ===\n");
    sf_snapshot(true);
    //press_to_cont();
    ...
    printf("=== Test8: 8192 byte allocation ===\n");
